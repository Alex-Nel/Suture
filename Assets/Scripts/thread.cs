...
public class Thread : MonoBehaviour
{
    ...
    void CreateSegments()
    {
        ...
        for (int i = 0; i < segmentCount; i++)
        {
            ...
            // segObj.GetComponent<MeshFilter>().transform.localScale = new Vector3(0.05f, 0.05f, 0.05f);
            ...
            ConfigurableJoint joint = segObj.AddComponent<ConfigurableJoint>();
            ...
            // SphereCollider collider = segObj.AddComponent<SphereCollider>();
        ...
        ConfigurableJoint finalJoint = endTransform.gameObject.AddComponent<ConfigurableJoint>();
